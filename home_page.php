  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav "> 
        <li class="navbar-item active"><a href="http://localhost/ProjectWP/home_page.php"><span class="glyphicon glyphicon-home"></span>&nbsp;Home</a></li>
  ...
  <!-- End  of Post Your Question-->
       <?php
						...
						echo "	<div class='row'>
									<div class='col-sm-12'>
										<div class='well'>
											<a href='home_page.php?reportedq=$temp' style='float:right;color:red;'>Report this question</a>
											<br/>
											...
											<div id='$id1' class='collapse'>
												...
												while($row2=mysqli_fetch_assoc($result3))
												{
													...
													".$upvotes." upvotes <a href='home_page.php?upvote=$upvotes&id=$id3' style='float:center;'><span class='glyphicon glyphicon-thumbs-up'></span>Upvote</a>
													&nbsp;&nbsp;&nbsp;&nbsp;
													<a href='home_page.php?reported=$id3' style='color:red;'> Report the Answer</a>
													<br/><br/>
													</td>
													</tr>
													<tr>
